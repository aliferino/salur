          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="#" aria-current="page" class="rounded-md bg-green-300 px-3 py-2 text-sm font-medium text-white">Beranda</a>
                <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-6x00 hover:text-green-500">Donasi</a>
                <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-6x00 hover:text-green-500">Galang Dana</a>
                <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-6x00 hover:text-green-500">Event</a>
                <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-6x00 hover:text-green-500">Reports</a>
              </div>
            </div>
          </div>
          <div class="hidden md:block">
