<nav class="bg-white flex items-center px-10 gap-3 w-full shadow-lg fixed h-[70px] z-9999">
    <div class="shrink-0 flex items-center gap-3 w-2/5">
    ...
    <div class="flex flex-row gap-5 w-2/5 justify-center">
        <div class="hidden md:block">
            <div class="flex items-baseline gap-x-2">
                <a href="/" class="{{ request()->is('/') ? 'text-white bg-green-800' : 'text-gray-400 hover:bg-gray-100 hover:text-green-600' }} w-[120px] rounded-xl px-3 py-2 text-sm font-medium text-center">Beranda</a>
                <a href="/donasi" class="{{ request()->is('donasi') ? 'text-white bg-green-800' : 'text-gray-400 hover:bg-gray-100 hover:text-green-600' }} w-[120px] rounded-xl px-3 py-2 text-sm font-medium text-center">Donasi</a>
                <a href="/galang-dana" class="{{ request()->is('galang-dana') ? 'text-white bg-green-800' : 'text-gray-400 hover:bg-gray-100 hover:text-green-600' }} w-[120px] rounded-xl px-3 py-2 text-sm font-medium text-center">Galang Dana</a>
            </div>
        </div>
