<div class="bg-green-800/90 p-10 text-white">
    <div class="flex flex-col gap-y-5">
        ...
        <div class="flex flex-col gap-2">
            <h1 class="text-4xl font-bold text-white">Tentang</h1>
            <div class="flex flex-col">
                <a href="#" class="text-base">SmartCare</a>
                <a href="#" class="text-base">Hubungi Kami</a>
                <a href="#" class="text-base">Partner Kami</a>
                <a href="#" class="text-base">Syarat & Ketentuan</a>
                <a href="#" class="text-base">Blog</a>
                <a href="#" class="text-base">FAQ</a>
            </div>
        </div>
        <div class="flex flex-col gap-2">
            <h1 class="text-4xl font-bold text-white">Bahasa</h1>
            <div class="flex gap-x-2">
                <a href="#" class="text-base border-2 rounded-full p-3">English</a>
                <a href="#" class="text-base border-2 rounded-full p-3">Indonesia</a>
            </div>
        </div>
    </div>
    <hr class="my-5">
